...
public class Calculator extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setBackground(new java.awt.Color(250, 255, 255));
        ...
        jButton17.setBackground(java.awt.SystemColor.activeCaptionBorder);
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(jButton13, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addComponent(jButton16, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 61, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(jButton19, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(jButton20, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        numInt = Integer.parseInt(jTextField1.getText());
        calculation = 1;
        jTextField1.setText("");
        jLabel1.setText(numInt + "+");
    ...
    public static void main(String args[]) {
        ...
        /*********************Define Variables********************************/
        double ans, num;
        int calculation, numInt, ansInt;
        
        /*************Creating My Own Class to Allow the Calculation**********/
        public void arithmetic_op()
        {
            if(calculation == 1)//Addition
            {
                ansInt = numInt + Integer.parseInt(jTextField1.getText());
                jTextField1.setText(Integer.toString(ansInt));
            }
            if(calculation == 2)//Substraction
            {
                ansInt = numInt - Integer.parseInt(jTextField1.getText());
                jTextField1.setText(Integer.toString(ansInt));
            }
            if(calculation == 3)//Multiplication
            {
                ansInt = numInt * Integer.parseInt(jTextField1.getText());
                jTextField1.setText(Integer.toString(ansInt));
            }
            if(calculation == 4)//Division
            {
                ans = num / Double.parseDouble(jTextField1.getText());
                jTextField1.setText(Double.toString(ans));
            }
            if (calculation ==5)//Modulus
            {
                ansInt = numInt % Integer.parseInt(jTextField1.getText());
                jTextField1.setText(Integer.toString(ansInt));
            }
